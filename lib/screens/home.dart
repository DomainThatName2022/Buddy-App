...
class _HomePageState extends State<HomePage> {
  ...
  // static const String lost_pet_icon = 'assets/images/lost_pet.png';
  // static const String found_pet_icon = 'assets/images/pet_found.png';
  // static const String matches_pet_icon = 'assets/images/all_matches.png';
                    ...
                    child: ListView(
                      ...
                      children: [
                        Padding(
                          ...
                          child: CustomCard("Gadget", "assets/images/pet1.jpg",
                              Icons.male, colors.male, "5 months", () {}),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: CustomCard("Lory", "assets/images/pet5.jpg",
                              Icons.male, colors.male, "4 years", () {}),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: CustomCard("Dave", "assets/images/pet3.jpg",
                              Icons.female, colors.female, "8 months", () {}),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: CustomCard("Dolly", "assets/images/pet6.jpg",
                              Icons.female, colors.female, "9 months", () {}),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: CustomCard("Busta", "assets/images/pet2.jpg",
                              Icons.male, colors.male, "8 months", () {}),
                        ),
                        Padding(
                          padding: const EdgeInsets.all(10.0),
                          child: CustomCard("Shovi", "assets/images/pet4.jpg",
                              Icons.female, colors.female, "1 year", () {}),
                        ),
                      ],
                    )),
              ),
